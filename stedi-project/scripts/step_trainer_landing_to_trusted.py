...
# Load Step Trainer Landing data (from Data Catalog)
step_trainer_landing = glueContext.create_dynamic_frame.from_catalog(
    database="stedi",
    table_name="step_trainer_landing"
).toDF()

# Load Curated Customers (consented customers with accelerometer data)
customer_curated = glueContext.create_dynamic_frame.from_catalog(
    database="stedi",
    table_name="customer_curated"
).toDF()

# Join step trainer data with curated customers on serialNumber
